...
`,""])),x,L,M),U=(0,g.Ps)(N||(N=(0,h.Z)([`
  ...
  books: contactBooks {
    ...
    `])));function te(t){var l=(0,f.Z)((0,f.Z)({},d),t);return w.a(U,l)}function ge(t){var l=_objectSpread(_objectSpread({},d),t);return Apollo.useLazyQuery(U,l)}var W=(0,g.Ps)(A||(A=(0,h.Z)([`
  ...
  book: contactBook(id: $id) {
    ...
    `])));function re(t){var l=(0,f.Z)((0,f.Z)({},d),t);return w.a(W,l)}function pe(t){var l=_objectSpread(_objectSpread({},d),t);return Apollo.useLazyQuery(W,l)}var K=(0,g.Ps)(R||(R=(0,h.Z)([`
  ...
  contacts(where: $where, page: $page) {
    ...
    `,`
`,""])),L,x);function xe(t){var l=_objectSpread(_objectSpread({},d),t);return Apollo.useQuery(K,l)}function G(t){var l=(0,f.Z)((0,f.Z)({},d),t);return u.t(K,l)}var V=(0,g.Ps)(S||(S=(0,h.Z)([`
    query contact($id: ID!) {
  contact(id: $id) {
    id
    ...ContactParts
