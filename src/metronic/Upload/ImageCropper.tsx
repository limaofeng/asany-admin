...
function ImageCropper(props: ImageCropperProps, ref: React.ForwardedRef<ImageCropperRef | null>) {
  const {
    width = '100%',
    height,
    zoomable,
...
export function ImageCropperModal(props: ImageCropperModalProps) {
  ...
  return (
    ...
    >
      <Modal.Body>
        <ImageCropperMemo ref={imageCropper} width={width} height={height} {...cropperProps} />
      </Modal.Body>
      <Modal.Footer>
