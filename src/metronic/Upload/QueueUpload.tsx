...
function QueueUpload(
  props: QueueUploadProps,
  ref: React.ForwardedRef<QueueUploadRef | null>,
) {
  ...
  const setAttachments = useCallback(
    async (
      files:
        | FileUploadObject[]
        | ((files: FileUploadObject[]) => FileUploadObject[]),
    ) => {
  ...
  return (
    <div
      {...rootProps}
      className={classnames('dropzone dropzone-queue', className)}
    >
      <input {...getInputProps()} />
        ...
        {attachments.map((item, i) => (
          ...
          >
            ...
            <div className="dropzone-toolbar">
              ...
              <span
                onClick={buildHandleDelete(item.id)}
