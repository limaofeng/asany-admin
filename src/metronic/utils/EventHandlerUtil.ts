...
export class EventHandlerUtil {
  ...
  public static setEventMetasByName(name: string, handlers: Record<string, EventMeta>): void {
    EventHandlerUtil.store[name] = handlers;
  }

  public static getEventMetaByName(name: string): Record<string, EventMeta> | undefined {
  ...
  public static setFiredByNameAndHandlerId(name: string, handerId: string, fired: boolean): void {
