...
const SelectMenuBody = React.forwardRef(function (
  props: SelectMenuBodyProps,
  ref: any,
) {
  const { options, closeDropdown, onSelect, itemRender, value, className } =
    props;
...
function DropdownSelect(
  props: SelectProps,
  ref: React.ForwardedRef<SelectRef | null>,
) {
  const {
    placement,
    offset,
