...
function RouteActions(props: RouteActionsProps) {
  ...
  const handleEventSilently = useCallback((e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
  }, []);
...
function RouteTree() {
  ...
  const handleSelect = useCallback((e: any) => {
    setState((prevState) => {
      ...
      return {
        ...
        route: {
          ...e.node,
          type: e.node.routeType,
          parentRoute: e.node.parentKey,
        },
      };
    });
  }, []);
  ...
  const handleDrop = useCallback(
    async (e: any) => {
      ...
      if (
        e.dragNode.parent?.id === e.toParentKey &&
                    ...
                    <div className="d-flex flex-column py-5">
                      <span
                        className={classnames(
                          'title  text-hover-primary mb-1 fs-6',
                          {
                      ...
                      <div className="d-flex flex-row col-stacked">
                        ...
                        {record.authorized && (
                          <Badge color="primary">需要登录</Badge>
                        )}
                      </div>
                    </div>
                    // <div className="d-flex flex-column py-5">
