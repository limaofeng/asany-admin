...
import { useMailboxMessageQuery } from '../hooks';
import { toPlainText } from '../utils';

import type { MailboxMessage } from '@/types';
import { Badge, Popover, Tooltip } from '@/pages/Metronic/components';
...
function MailMessageActions(props: MailMessageActionsProps) {
  ...
  return (
    <div className="d-flex">
      ...
      <Tooltip placement="bottom" title="标记为已读">
        <a className="btn btn-sm btn-icon btn-light btn-active-light-primary me-2">
          <Icon name="Duotune/gen028" className="svg-icon-2 m-0" />
        </a>
      </Tooltip>
  ...
  return (
    <div className="d-flex align-items-center">
      ...
      >
        ...
        <Icon name="Duotune/arr074" className="svg-icon-2 m-0" />
        {/*--end::Svg Icon--*/}
      </a>
      {/*--end::Prev page--*/}
      {/*--begin::Next page--*/}
      ...
      >
        ...
        <Icon name="Duotune/arr071" className="svg-icon-2 m-0" />
        {/*--end::Svg Icon--*/}
      </a>
      {/*--end::Next page--*/}
      {/*--begin::Settings menu--*/}
    ...
    >
      <div className="card mail-message-container">
        <div className="card-header align-items-center py-5 gap-5">
          <MailMessageActions mailbox={mailbox} />
          <Pagination />
        </div>
...
function MessageWrapper(props: MessageWrapperProps) {
  ...
  return (
    <div className={classnames('message_wrapper', { shrink: !expand })}>
      ...
      <div className="d-flex flex-wrap gap-2 cursor-pointer" onClick={handleHandover}>
        {/*--begin::Author--*/}
        <div className="d-flex align-items-center">
          {/*--begin::Avatar--*/}
          <Avatar
          ...
          <div className="pe-5">
            ...
            <div
              className={classnames('message_wrapper_preview-message text-muted fw-bold', {
                'd-none': expand,
              })}
            >
