...
const CalendarActions = React.forwardRef(function (
  props: CalendarActionsProps,
  ref: any,
) {
...
function CalendarListFooter(props: CalendarListFooterProps) {
  ...
  const { data } = useCalendarAccountsQuery({
  ...
  return (
    <div className="calendars-footer">
      <Dropdown
        overlay={
          <CalendarActions
            ...
            accounts={calendarAccounts as any}
          />
        }
      ...
      <a
        ...
        className={classnames({ disabled: !selectedItem })}
      >
