...
function MessageEditor(props: MessageEditorProps) {
  ...
  const [autoSave, saving] = useAutoSave<MailboxMessageCreateInput>(
    async (_, values) => {
  ...
  const { message, recipients, mode, autoSaveState, disabled, sending } =
    state.current;
              ...
              <div className="btn-group me-4">
                <Button
                  ...
                  icon={
                    <Icon
                      name="Duotune/gen016"
                      className="svg-icon-1 ms-n4 me-4"
                    />
                  }
