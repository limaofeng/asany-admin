    ...
    <div className="article-settings">
      <Form onValuesChange={handleChange} component={false}>
            ...
            return (
              <>
                ...
                <p className="mt-1 text-gray-600">
                  localhost:2368/{form.getFieldValue('slug')}/
                </p>
              </>
            );
          }}
        ...
        <Form.Item className="mb-10" name="access" label="访问权限">
          <Select2
            size="sm"
            options={[{ value: 'public', label: '完全公开' }]}
          />
        </Form.Item>
...
function ArticleEditor(props: ArticleEditorProps) {
  ...
  useEffect(() => {
    ...
    state.data = {
      ...props.data,
      categories: props.data.categories.map((item: any) => item.id),
    };
    state.temp = {} as any;
    ...
    async (values: any) => {
      ...
      if (state.status === 'New') {
        ...
        state.temp = await delay(
          Promise.resolve({ ...state.temp, ...values }),
          350,
        );
        state.saved = 'NotSaved';
        forceRender();
  ...
  const handlePressEnterOfTitle = useCallback(
        ...
        <div className="art-editor">
            ...
            <div className="tw-flex">
              {stateRef.current.status !== 'New' && (
                <>
                  ...
                  <Button
                    variant="white"
                    className={classnames({ 'me-3': settingsMenuCollapsed })}
                  >
                    发布
                  </Button>
                </>
              ...
              {settingsMenuCollapsed && (
                <div className="settings-menu-toggle-spacer" />
              )}
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              <div
                ref={coverContainer}
                className="art-editor-feature-image-container"
              >
                <div
