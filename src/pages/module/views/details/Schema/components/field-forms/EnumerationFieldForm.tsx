...
type EnumerationFieldFormProps = {
  form: FormInstance<any>;
};

function EnumerationFieldForm(props: EnumerationFieldFormProps) {
  const { form } = props;
    ...
    <Form form={form}>
      ...
      >
        ...
        <div className="field-options">
          <div className="field-options__name text-dark fs-base fw-semibold">
            字段选项
          </div>
          <div className="field-options__list d-flex flex-column">
            ...
            <Form.Item
              ...
              help={
                <div style={{ marginLeft: 26 }}>存储值列表而不是单个值</div>
              }
            >
        ...
        <div className="field-advanced">
          ...
          <div className="field-advanced__list d-flex flex-column">
            <Form.Item
              ...
              name="required"
              help={
                <div style={{ marginLeft: 26 }}>使用此值预填充表单输入</div>
              }
            >
...
export default EnumerationFieldForm;
