...
import { Button, Card, Input, Nav, Table } from '@/pages/Metronic/components';
...
function FileManager(props: FileManagerProps) {
  ...
  console.log('storage-id', params.id, props.location.pathname);
                          ...
                          <div className="card-body p-5">
                            ...
                            >
                              ...
                              <div className="text-muted fw-normal mt-2 fs-8 px-3">
                                Read only.
                                <a
                                  href="../../demo7/dist/apps/file-manager/settings/.html"
                                  className="ms-2"
                                >
                                  Change permissions
                                </a>
