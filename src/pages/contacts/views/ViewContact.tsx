...
import { OutletContextState } from '../typings';

function ViewContact() {
  const match = useMatch({ path: '/contacts/:group/:cid', end: false });

  const context = useOutletContext<OutletContextState>();
  ...
  const contact = useMemo(() => {
    return data?.contact || context.contact;
  }, [data?.contact, context.contact]);
