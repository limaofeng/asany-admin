...
import useUserDelete from '@/pages/system/hooks/useUserDelete';
import { User, UserWhereInput } from '@/types';
...
function UserList(props: UserListProps, _ref: React.Ref<UserListRef>) {
  ...
  const variables = useMemo(() => {
    const newVariables = queryToVariables(
      searchParams,
      [
        {
          source: 'q',
