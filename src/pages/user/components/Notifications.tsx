...
import { Menu, Tabs } from '@/metronic';
...
function Notifications(props: NotificationsProps) {
  ...
  return (
    <Menu
      mode="vertical"
      dropdown
      className={classnames('w-350px w-lg-375px', { show: visible })}
      onClick={handleClick}
    >
      <div
        className="d-flex flex-column bgi-no-repeat rounded-top"
        style={{ backgroundImage: "url('/assets/media/misc/dropdown-header-bg.png')" }}
      >
        ...
        <Tabs
          type="line-tabs"
          tabBarClassName="text-white opacity-75 opacity-state-100 pb-4"
          className="nav-line-tabs-2x nav-stretch fw-semibold px-9"
          contentContainer={contentContainer}
        >
          <Tabs.TabPane tab="通知" key="notifications">
            {/*--begin::Items--*/}
          ...
          <Tabs.TabPane tab="消息" key="messages">
      ...
      <div ref={buildContentContainer} id="notifications-tab-content-container" />
    </Menu>
  );
}
