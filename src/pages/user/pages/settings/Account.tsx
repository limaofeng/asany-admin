      ...
      <Card className="mb-5 mb-xl-10">
        ...
        <Card.Body>
          ...
          <p className="mt-5 mb-3 text-gray-700 text-small d-flex align-items-center">
            <Icon
              className="text-gray-800 svg-icon-4 me-1"
              name="Bootstrap/question-circle"
            />
            想要管理帐户安全设置？您可以在{' '}
            <Link to="/settings/security">帐户安全</Link>
            选项卡中找到它们。
          </p>
        </Card.Body>
      </Card>
      <Card className="mb-5 mb-xl-10">
        ...
        <Card.Body>
          {organizations.length ? (
            <div className="fs-7">
              <p>
                您的帐户目前是这些组织的所有者： w-asany 您必须先 删除自己、
                转移所有权或
              </p>
              <p>
                在删除用户之前，必须先将自己从组织中移除、转移所有权或删除这些组织。
              </p>
            </div>
          ) : (
