        ...
        <div className="d-flex flex-column-fluid flex-items-center">
          ...
          <span>
            ...
            <Tooltip title="此电子邮件将用于与帐户相关的通知，也可用于密码重置。">
              <Icon className="text-gray-800 svg-icon-4 ms-1" name="Bootstrap/info-circle" />
            </Tooltip>
          </span>
        </div>
        <a className="remove-email">
          <Icon className="text-danger svg-icon-4 svg-icon" name="Bootstrap/trash" />
        </a>
      </div>
          ...
          <>
            <li className="text-gray-700">
              <div className="d-flex align-items-center">
                ...
                <Tooltip title="此电子邮件将用于与帐户相关的通知，也可用于密码重置。">
                  <Icon className="text-gray-800 svg-icon-4 mx-1" name="Bootstrap/info-circle" />
                </Tooltip>
              ...
              {() => (
                <>
                  <p className="mt-3 mb-4">
                    <code>limaofeng@msn.com</code>将用于与帐户相关的通知，并可用于密码重置。
                  </p>
                  <div className="d-flex align-items-center">
                    <Form.Item noStyle name="email">
                      <Select
      ...
      <Card className="mb-5 mb-xl-10 settings-email-preferences">
        ...
        <Card.Body>
          <div className="form-checkbox">
            ...
            <p className="note">我们偶尔会与您联系，已便您了解我们最新消息和事件。</p>
          </div>
          <div className="form-checkbox">
            <Radio solid value="2">
