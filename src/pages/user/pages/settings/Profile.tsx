                ...
                <div className="col-lg-8 fv-row">
                  ...
                  >
                    ...
                    <option data-kt-flag="flags/north-korea.svg" value="KP">
                      Korea, Democratic People&aposs Republic of
                    </option>
                    ...
                    <option data-kt-flag="flags/laos.svg" value="LA">
                      Lao People&aposs Democratic Republic
                    </option>
              ...
              <div className="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                ...
                <div className="mb-3 mb-md-0 fw-bold">
                  ...
                  <div className="fs-6 text-gray-700 pe-7">
                    ...
                    log in, in addition you&aposll need to provide a 6 digit code
                  </div>
                </div>
                {/*--end::Content--*/}
                {/*--begin::Action--*/}
              ...
              <div className="d-flex flex-stack flex-grow-1">
                ...
                <div className="fw-bold">
                  <div className="fs-6 text-gray-700">
                    Two-factor authentication adds an extra layer of security to your account. To
                    log in, in you&aposll need to provide a 4 digit amazing code.
            ...
            <div className="card-body border-top p-9">
              ...
              <div className="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                ...
                <div className="d-flex flex-stack flex-grow-1">
                  {/*--begin::Content--*/}
                  <div className="fw-bold">
                    <h4 className="text-gray-900 fw-bolder">You Are Deactivating Your Account</h4>
                    <div className="fs-6 text-gray-700">
                      For extra security, this requires you to confirm your email or phone number
                      when you reset yousignr password.
                      <br />
