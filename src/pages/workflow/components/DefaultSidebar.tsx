    ...
    <AsideWorkspace width={280} className="app-sidebar app-contacts-sidebar">
      ...
      >
        <Menu
          ...
          fit={true}
        >
          <Menu.Item url="/workflow/launcher" icon="Fonticon/send" key="started">
            发起流程
          </Menu.Item>
          <Menu.Item url="/workflow/search" icon="Bootstrap/search" key="search">
            流程查询
          </Menu.Item>
          ...
          <Menu.Item bullet url="/workflow/settings/xxx" key="project_settings_workflow">
            工作流
          </Menu.Item>
        </Menu>
      </OverlayScrollbarsComponent>
