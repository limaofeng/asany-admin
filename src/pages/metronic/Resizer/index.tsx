...
const Resizer = ({ onResize }: ResizerProps) => {
  ...
  return (
    <>
      <div className="top-left" onMouseDown={handleMouseDown(Direction.TopLeft)} />

      <div className="top" onMouseDown={handleMouseDown(Direction.Top)} />

      <div className="top-right" onMouseDown={handleMouseDown(Direction.TopRight)} />

      <div className="right" onMouseDown={handleMouseDown(Direction.Right)} />

      <div className="right-bottom" onMouseDown={handleMouseDown(Direction.BottomRight)} />

      <div className="bottom" onMouseDown={handleMouseDown(Direction.Bottom)} />

      <div className="bottom-left" onMouseDown={handleMouseDown(Direction.BottomLeft)} />
