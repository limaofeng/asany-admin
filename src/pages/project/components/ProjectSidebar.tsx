    ...
    <AsideWorkspace width={280} className="app-sidebar app-contacts-sidebar">
      ...
      >
        <Menu
          ...
          fit={true}
        >
          <Menu.Item url="/projects/dashboard" icon="Bootstrap/speedometer2" key="dashboard">
            首页
          </Menu.Item>
          <Menu.Item url="/projects/my/tasks" icon="Bootstrap/list-task" key="mytasks">
            我的任务
          </Menu.Item>
          <Menu.Item url="/projects/my/tasks" icon="Bootstrap/inbox" key="upcoming">
            收件箱
          </Menu.Item>
          <Menu.Item url="/projects/my/tasks" icon="Bootstrap/journal-check" key="logs">
            日志薄
          </Menu.Item>
