...
function ProjectView(props: ProjectViewProps) {
  ...
  const menuKey = useMemo(() => {
    const channelMatch = matchPath<{ sid: string; cid: string }>(
      location.pathname,
      {
        path: '/project/:id/:key',
        exact: false,
          ...
          <MicroApp.Sidebar>
            ...
            >
              ...
              >
                ...
                />
                <Menu.Section contentClassName="pt-6 pb-0">
                  基础功能
                </Menu.Section>
                <Menu.Item
                  bullet={true}
                  title="目标"
                  url={`/projects/${project.id}/targets`}
                />
                <Menu.Item
                  bullet={true}
                  title="任务"
                ...
                <Menu.Item
                  bullet={true}
                  title="活动"
                  url={`/projects/${project.id}/activity`}
                />
