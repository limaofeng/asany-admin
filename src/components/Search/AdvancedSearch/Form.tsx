    ...
    <>
      ...
      <Row gutter={8} className="mb-8">
        ...
        <Col xxl={5}>
          <Row gutter={8}>
            <Col lg={6}>
              <label className="fs-6 form-label fw-bold text-dark">Team Type</label>
              {/*--begin::Select--*/}
              <select
            ...
            <Col lg={6}>
              <label className="fs-6 form-label fw-bold text-dark">Select Group</label>
              {/*--begin::Radio group--*/}
      ...
      <Row gutter={8}>
        <Col xxl={7}>
          <Row gutter={8}>
            <Col lg={4}>
              <label className="fs-6 form-label fw-bold text-dark">Min. Amount</label>
              {/*--begin::Dialer--*/}
              <div
            ...
            <Col lg={4}>
              <label className="fs-6 form-label fw-bold text-dark">Max. Amount</label>
              {/*--begin::Dialer--*/}
              <div
                className="position-relative"
                data-kt-dialer="true"
            ...
            <Col lg={4}>
              <label className="fs-6 form-label fw-bold text-dark">Team Size</label>
              <input
                type="text"
                className="form-control form-control form-control-solid"
                name="city"
        ...
        <Col xxl={5}>
          <Row gutter={8}>
            <Col lg={6}>
              <label className="fs-6 form-label fw-bold text-dark">Category</label>
              {/*--begin::Select--*/}
              <select
                className="form-select form-select-solid"
                data-control="select2"
