...
export const SET_RECV_FRIEND_APPLICATION_LIST =
  'SET_RECV_FRIEND_APPLICATION_LIST';
export const SET_SENT_FRIEND_APPLICATION_LIST =
  'SET_SENT_FRIEND_APPLICATION_LIST';
export const SET_RECV_GROUP_APPLICATION_LIST =
  'SET_RECV_GROUP_APPLICATION_LIST';
export const SET_SENT_GROUP_APPLICATION_LIST =
