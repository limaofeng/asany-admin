    ...
    <Dropdown
      ...
      overlay={
        ...
        >
          <Menu.Item
            className="px-3 my-0"
            linkClassName={classnames('px-3 py-2', { active: menuMode === 'light' })}
          ...
          <Menu.Item
            className="px-3 my-0"
            linkClassName={classnames('px-3 py-2', { active: menuMode === 'dark' })}
          ...
          <Menu.Item
            className="px-3 my-0"
            linkClassName={classnames('px-3 py-2', { active: menuMode === 'system' })}
